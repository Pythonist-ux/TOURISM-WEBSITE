...
<body>
    <header>
        ...
        <a href="#contact" class="cta"><button>Contact Us</button></a>
    </header>
...
<br>
        ...
        <div class="box-container">
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="150">
                ...
                <div class="content">
                    ...
                    <a href="maldives.html">read more <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="750">
                ...
                <div class="content">
                    <h3>JAPAN</h3>
                    <p>Japan->Endless Discovery</p>
                    <a href="japan.html">read more <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="1300">
                ...
                <div class="content">
                    <h3>SEOUL</h3>
                    <p>Country Of Morning-"Fresh"</p>
                    <a href="seoul.html">read more <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
    ...
    <form class="contact" id="contact" action="" method="get" onsubmit="login1()";>
        ...
        <div class="form">
            <input class="form-input" type="text" pattern="[A-Za-z] name="name" id="name" placeholder="Enter Your Name">
            ...
            <button class="w2btn "onclick="login1()">Submit</button>
